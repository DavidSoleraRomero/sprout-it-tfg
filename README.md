...
Vídeo final del TFG donde se explica de qué trata *Sprout It* y se abarca todo su funcionamiento. Incluye una introducción clara y una demostración completa de la app, destacando sus principales utilidades y características.
...
- 🔗 **APK para Android de la aplicación web**  
  [Descargar en Google Drive](https://drive.google.com/file/d/1Z0HV5_0lxEzCFZj9XGA7OFUhR6sSWaqm/view?usp=sharing)
...
- 🔗 **APK para Android**  
  [Descargar en Google Drive](https://drive.google.com/file/d/1FOxGJmtvxA0Iw1a82kUKVfSXQJp-8wwW/view?usp=drive_link)
